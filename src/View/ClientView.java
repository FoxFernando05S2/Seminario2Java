...
public class ClientView extends JPanel {
    ...
    public JTextField txtCompanyName = new JTextField(20);
    public JTextField txtContactNumber = new JTextField(15);
    ...
    private JScrollPane scrollPane = new JScrollPane(clientTable);
    ...
    public ClientView() {
        ...
        panelForm.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(borderColor, 2), "Client Data", 0, 0, fontBold, borderColor));
        ...
        panelForm.add(styledLabel("Company Name:", fontBold, fontColor));
        txtCompanyName.setFont(font);
        panelForm.add(txtCompanyName);

        panelForm.add(styledLabel("Contact Number:", fontBold, fontColor));
        txtContactNumber.setFont(font);
        panelForm.add(txtContactNumber);
        ...
        scrollPane.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(borderColor, 2), "Client List", 0, 0, fontBold, borderColor));
        clientTable.setFont(font);
        clientTable.setRowHeight(28);
        clientTable.getTableHeader().setFont(fontBold);
        clientTable.getTableHeader().setBackground(borderColor);
        clientTable.getTableHeader().setForeground(Color.WHITE);
        clientTable.setSelectionBackground(buttonColor);
    ...
    public void updateClientTable(Object[][] data, String[] columnNames) {
